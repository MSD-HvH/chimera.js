                ...
                switch (current_item.type) {
                    ...
                    case 'checkbox' : 
                        ...
                        if (current_item_condition) {
                            ...
                            Render.String(x + 9 + 10 + 12 + 5 + 1, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] - 1.5 + 1, 0, current_item.name, [0, 0, 0, Math.round(alpha * 255)], font.default)
                            ...
                            if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u]], [x + 9 + 10 + 12 + name_sz[0] + 5, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 12]) && menu.helpers.input_is_key_pressed(0x01) && (menu.data.item_in_use == null || menu.data.item_in_use == i) && alpha > 0.98) {
                            ...
                            if (value_alpha > 0) {
                                Render.FilledRect(x + 9 + 10 + 3, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3, 6, 6,  menu.helpers.override_alpha(menu.colors.orange, alpha * value_alpha))
                            }
                    ...
                    case 'slider' : 
                        ...
                        if (current_item_condition) {
                            ...
                            Render.String(x + 9 + 10 + 1, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] - 2 + 1, 0, current_item.name, [0, 0, 0, Math.round(alpha * 255)], font.default)
                            ...
                            if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 9, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3], [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 9 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 18, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3 + 6]) && Input.IsKeyPressed(0x01) && (menu.data.item_in_use == null || menu.data.item_in_use == i) && alpha > 0.98) {
                            ...
                            if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 9, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3], [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 9 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 18, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3 + 6]) && (menu.data.item_in_use == null || menu.data.item_in_use == i) && alpha > 0.98) {
                            ...
                            Render.String(x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 9 - 5 + ((w / 2 - 9 * 2 + 9 * 0.5) / 2 - 18 - 2) * pixel_value + value_size[0] / 2 + 1, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] - 9 + 1, 1, '' + current_item.value, [0, 0, 0, Math.round(alpha * 255)], font.extra_small)
                    ...
                    case 'dropdown' :
                        ...
                        if (current_item_condition) {
                            ...
                            Render.String(x + 9 + 10 + 5 + 1, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 15 - 2 + 1, 0, current_item.table[current_item.value], [0, 0, 0, Math.round(alpha * 255)], font.default)
                            ...
                            if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 15], [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 18, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 15 + 12]) && menu.helpers.input_is_key_pressed(0x01) && (menu.data.item_in_use == null || menu.data.item_in_use == i) && alpha > 0.98 ) {
                    ...
                    case 'colorpicker' : 
                        ...
                        if (current_item_condition) {
                            ...
                            Render.String(x + 9 + 10 + 1, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] - 2 + 1, 0, current_item.name, [0, 0, 0, Math.round(255 * alpha)], font.default)
                            ...
                            if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u]], [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) - 27, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 12]) && menu.helpers.input_is_key_pressed(0x01) && alpha > 0.98) {
                            ...
                            if (colorpicker_alpha > 0) {
                                ...
                                for (f in colors) {
                                    Render.FilledRect(x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 12 + offset * colorpicker_alpha, (w / 2 - 9 * 2 + 9 * 0.5) - 18, 14, menu.helpers.override_alpha(menu.colors.extra, alpha * colorpicker_alpha))

                                    var pixel_value = math.lerp_reverse(current_item.color[f], 0, 255)

                                    Render.FilledRect(x + 9 + 10 + 35, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3 + 12 + offset,  (w / 2 - 9 * 2 + 9 * 0.5) - 18 - 15 - 23, 6, menu.helpers.override_alpha(menu.colors.background, alpha * colorpicker_alpha))
                                    Render.FilledRect(x + 9 + 10 + 35 + 1, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3 + 12 + offset + 1,  ((w / 2 - 9 * 2 + 9 * 0.5) - 18 - 15 - 23 - 2) * pixel_value, 6 - 2, menu.helpers.override_alpha(colors[f][1], alpha * colorpicker_alpha))
                                    Render.String(x + 9 + 10 + 3 + 1, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 11 + offset + 1, 0, colors[f][0], [0, 0, 0, Math.round(255 * alpha * colorpicker_alpha)], font.default)
                                    Render.String(x + 9 + 10 + 3, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 11 + offset, 0, colors[f][0], [255, 255, 255, Math.round(255 * alpha * colorpicker_alpha)], font.default)

                                    if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10 + 35, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3 + 12 + offset], [x + 9 + 10 + 35 + (w / 2 - 9 * 2 + 9 * 0.5) - 18 - 15 - 23, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3 + 12 + offset + 6]) && Input.IsKeyPressed(0x01) && alpha > 0.98 && colorpicker_alpha > 0.98) {
                                ...
                                if (menu.helpers.input_is_key_pressed(0x01) && !menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u]], [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) - 27, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 12 + offset]) && alpha > 0.98) {
                                    current_item.is_visible = false
                                }
                    ...
                    case 'label' :
                        if (current_item_condition) {
                            ...
                            Render.String(x + 9 + 10 + 1, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] - 2 + 1, 0, current_item.value, [0, 0, 0, Math.round(255 * alpha)], font.default)
                            Render.String(x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] - 2, 0, current_item.value, [255, 255, 255, Math.round(255 * alpha)], font.default)
