...
menu.render = function() {
    ...
    var menu_alpha = visual_controller.new_animation('menu_alpha', 1)
    ...
    Render.String(x_pos + 9 + 5, y + menu_border + 9 + 2, 0, 'Main', [255, 184, 116, Math.round(255 * menu_alpha)], font.subtab)
    Render.String(x_pos + w / 2 + 9 * 0.5 + 5, y + menu_border + 9 + 2, 0, 'Other', [255, 184, 116, Math.round(255 * menu_alpha)], font.subtab)
    ...
    for (j in menu.data.items) {
        ...
        if (menu.data.current_tab == j) {
            ...
            var color = [255, 184, 116, 255]
        }
    

        Render.Text(x_pos + 103 + tab_space * tab_render + tab_space / 2, y + menu_border / 2 - 5 , 1, j, color, font.tab )
        Render.Text(x_pos + 103 + tab_space * tab_render + tab_space / 2, y + menu_border / 2 + 5, 1, tab_description[tab_render], color, font.tab_description )
      //  Render.FilledRect(x + 103 + tab_space * tab_render, y, 1, menu_border, menu.colors.orange)

        if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x_pos + 103 + tab_space * tab_render, y], [x_pos + 103 + tab_space * tab_render + tab_space, y + menu_border]) && menu.helpers.input_is_key_pressed(0x01)) {
    ...
    for (h in menu.data.items) {
        ...
        for (u in menu.data.items[h]) {
            ...
            for (i in menu.data.items[h][u]) {
                ...
                var current_item_condition = current_item != undefined && (h == menu.data.current_tab) && current_item.enabled && visual_controller.get_animation('menu_alpha').number > 0.9//&& ((menu_border * 1.5 + 50 + item_spacing[h][u]) < height)
                ...
                if (current_item_condition) {
                    var alpha = visual_controller.new_animation(i, 1)
                }
                else {
                    var alpha = 0
                }
                ...
                switch (current_item.type) {
                    ...
                    case 'checkbox' : 
                        ...
                        if (current_item_condition) {
                            ...
                            Render.FilledRect(x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u], 12, 12, menu.helpers.override_alpha(menu.colors.background, alpha))
                            Render.String(x + 9 + 10 + 12 + 5, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] - 1.5, 0, current_item.name, [255, 255, 255, Math.round(alpha * 255)], font.default)

                            var name_sz = Render.TextSize(current_item.name, font.default)

    
                            if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u]], [x + 9 + 10 + 12 + name_sz[0] + 5, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 12]) && menu.helpers.input_is_key_pressed(0x01) && (menu.data.item_in_use == null || menu.data.item_in_use == i) ) {
                            ...
                            if (current_item.value) {
                                Render.FilledRect(x + 9 + 10 + 3, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3, 6, 6,  menu.helpers.override_alpha(menu.colors.orange, alpha))
                            }
                    ...
                    case 'button' :
                        ...
                        if (current_item_condition) {
                            ...
                            if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u]], [x + 9 + 10 + name_sz[0] + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 12]) && menu.helpers.input_is_key_pressed(0x01) && (menu.data.item_in_use == null || menu.data.item_in_use == i) ) {
                    ...
                    case 'slider' : 
                        ...
                        if (current_item_condition) {
                            ...
                            Render.FilledRect(x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 9, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3, (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 18 , 6, menu.helpers.override_alpha(menu.colors.background, alpha))
                            Render.String(x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] - 2, 0, current_item.name, [255, 255, 255, Math.round(alpha * 255)], font.default)

                            var value_size = Render.TextSize( '' + current_item.value, font.extra_small )

                            if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 9, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3], [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 9 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 18, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3 + 6]) && Input.IsKeyPressed(0x01) && (menu.data.item_in_use == null || menu.data.item_in_use == i)) {
                            ...
                            if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 9, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3], [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 9 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 18, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3 + 6]) && (menu.data.item_in_use == null || menu.data.item_in_use == i)) {
                            ...
                            Render.FilledRect(x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 9 + 1, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3 + 1, ((w / 2 - 9 * 2 + 9 * 0.5) / 2 - 18 - 2) * pixel_value, 6 - 2, menu.helpers.override_alpha(menu.colors.orange, alpha)) /// (x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 9 + 1)

                            Render.String(x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 9 - 5 + ((w / 2 - 9 * 2 + 9 * 0.5) / 2 - 18 - 2) * pixel_value + value_size[0] / 2, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] - 9, 1, '' + current_item.value, [255, 255, 255, Math.round(alpha * 255)], font.extra_small)
                    ...
                    case 'dropdown' :
                        ...
                        if (current_item_condition) {
                            ...
                            Render.String(x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] - 2, 0, current_item.name, [255, 255, 255, Math.round(alpha * 255)], font.default)
                            Render.FilledRect(x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 15, (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 18, 12, menu.helpers.override_alpha(menu.colors.background, alpha))
                            Render.String(x + 9 + 10 + 5, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 15 - 2, 0, current_item.table[current_item.value], [255, 255, 255, Math.round(alpha * 255)], font.default)
                            
                            if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 15], [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 18, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 15 + 12]) && menu.helpers.input_is_key_pressed(0x01) && (menu.data.item_in_use == null || menu.data.item_in_use == i) ) {
                            ...
                            if (current_item.is_visible) {
                                ...
                                for (e in current_item.table) {
                                    ...
                                    Render.FilledRect(x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 15 + 12 + offset, (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 18, 12, menu.helpers.override_alpha(e == current_item.value ? menu.colors.orange : menu.colors.extra, alpha))//я чо хуй знает как сделать
                                    Render.String(x + 9 + 10 + 5, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] - 2 + offset + 27, 0, current_item.table[e], [255, 255, 255, Math.round(alpha * 255)], font.default)

                                    if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 15 + 12 + offset], [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 18, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 15 + 12 + offset + 12]) && menu.helpers.input_is_key_pressed(0x01)) {
                                ...
                                if (menu.helpers.input_is_key_pressed(0x01) && !menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 15], [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) / 2 - 18, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 15 + 12 + offset])) {
                                    current_item.is_visible = false
                                }
                            ...
                            item_spacing[h][u] = item_spacing[h][u] + 22 * alpha + offset + 12
                        }
                    ...
                    case 'colorpicker' : 
                        ...
                        if (current_item_condition) {
                            ...
                            Render.String(x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] - 2, 0, current_item.name, [255, 255, 255, Math.round(255 * alpha)], font.default)

                            Render.FilledRect(x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) - 27 - 20, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3, 20, 6, menu.helpers.override_alpha(menu.colors.background, alpha))

                            Render.FilledRect(x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) - 27 - 20 + 1, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3 + 1, 18, 4, menu.helpers.override_alpha(current_item.color, alpha))

                            if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u]], [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) - 27, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 12]) && menu.helpers.input_is_key_pressed(0x01)) {
                            ...
                            if (current_item.is_visible) {
                                ...
                                for (f in colors) {
                                    Render.FilledRect(x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 12 + offset, (w / 2 - 9 * 2 + 9 * 0.5) - 18, 14, menu.helpers.override_alpha(menu.colors.extra, alpha))

                                    var pixel_value = math.lerp_reverse(current_item.color[f], 0, 255)

                                    Render.FilledRect(x + 9 + 10 + 35, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3 + 12 + offset,  (w / 2 - 9 * 2 + 9 * 0.5) - 18 - 15 - 23, 6, menu.helpers.override_alpha(menu.colors.background, alpha))
                                    Render.FilledRect(x + 9 + 10 + 35 + 1, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3 + 12 + offset + 1,  ((w / 2 - 9 * 2 + 9 * 0.5) - 18 - 15 - 23 - 2) * pixel_value, 6 - 2, menu.helpers.override_alpha(colors[f][1], alpha))
                                    Render.String(x + 9 + 10 + 3, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 11 + offset, 0, colors[f][0], [255, 255, 255, Math.round(255 * alpha)], font.default)

                                    if (menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10 + 35, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3 + 12 + offset], [x + 9 + 10 + 35 + (w / 2 - 9 * 2 + 9 * 0.5) - 18 - 15 - 23, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 3 + 12 + offset + 6]) && Input.IsKeyPressed(0x01)) {
                                ...
                                if (menu.helpers.input_is_key_pressed(0x01) && !menu.helpers.in_bounds(Input.GetCursorPosition(), [x + 9 + 10, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u]], [x + 9 + 10 + (w / 2 - 9 * 2 + 9 * 0.5) - 27, y + menu_border * 1.5 + 9 + 10 + item_spacing[h][u] + 12 + offset])) {
                                    current_item.is_visible = false
                                }
                            ...
                            item_spacing[h][u] = item_spacing[h][u] + 22 * alpha + offset
                        }
                    break;
...
menu.new_colorpicker = function(tab, subtab, name, visibility_condition) {
    if (!menu.data.items[tab][subtab]) {
        menu.data.items[tab][subtab] = {}
    }
    ...
    if (!menu.data.items[tab][subtab][name]) {
        ...
        menu.data.items[tab][subtab][name].color = [255, 255, 255, 255]
        menu.data.items[tab][subtab][name].is_visible = false
...
menu.get_value = function(tab, subtab, name) {
    return menu.data.items[tab][subtab][name].value
}
...
visual_controller.alternative_indicators = function() {
    ...
    var desync_angle = Math.floor(Math.min(Math.abs(Local.GetRealYaw() - Local.GetFakeYaw()) / 2, 60)) 
...
visual_controller.end_render = function() {
    ...
    if (menu.data.current_tab == 'CONFIGS') {
        antibrute_phases = menu.get_value('ABF', '1', 'я ебал просто какая же она ахуенная... ее лицо... ее руки... ее тело... я не могу сдерживать свои эмоции')
...
anti_bruteforce.create_new_phase = function() {
    if (anti_bruteforce.menu_elements.length > 11) {
        Cheat.PrintLog('нахуй тебе столько фаз ебанат', [0, 255, 0, 255])
        return
    }
...
anti_bruteforce.remove_phase = function() {
    if (anti_bruteforce.menu_elements.length <= 2) {
        Cheat.PrintLog('куда меньше то долбаеб', [255, 0, 0, 255])
        return
    }
